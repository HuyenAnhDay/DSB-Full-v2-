...
import { SKILL_GAPS, CERTS, BADGES, COURSES } from './data.js';
...
import { AppShell, Sidebar, TopBar, SecondaryNav, PageHeader, Page, AIBuddyPopover } from './shell.jsx';
...
function ScreenILead({ screen }) {
  ...
  // Legacy / direct routes (kept so nothing breaks)
...
export { ScreenILead, OnboardingMG };
