...
const NAV = {
  dashboard: [
    { id: "dashboard", label: "Tổng quan", icon: "dashboard", sub: "Home" }
  ],
  ilead: [
    { id: "ilead/job",   label: "Job track",   icon: "work",       sub: "Onboarding 30-60-90 · Mentor" },
    { id: "ilead/depth", label: "Depth track", icon: "psychology", sub: "BMI · ICM · Sống Nền+Nếp" },
    { id: "ilead/idp",   label: "IDP track",   icon: "route",      sub: "Cert · Roadmap · Migration" }
  ],
  dwork: [
    { group: "FC", items: [
      ...
      { id: "dwork/omni",      label: "Omni channel", icon: "forum",       sub: "OM · DM · Workflow" }
    ] },
    { group: "OC", items: [
      { id: "dwork/oc", label: "OC", icon: "support_agent", sub: "Operations Center" }
    ] }
  ],
  dlink: [
    { group: "IPAX", items: [
      { id: "dlink/ipax", label: "IPAX", icon: "self_improvement", sub: "Tự phản tư · Self-reflection" }
    ] },
    { group: "XLink", items: [
  ...
  toolbox: [
    { id: "toolbox", label: "Toolbox", icon: "build", sub: "Agenda · Simulator" }
  ],
  library: [
    { id: "library/kb", label: "KB Note", icon: "sticky_note_2", sub: "Knowledge base · Helpdesk" }
  ]
};

// All navigable sections (compasses + utility), used for route → section resolution
const SECTIONS = [
  { id: "dashboard", label: "Dashboard", question: "Tổng quan toàn hệ thống", icon: "dashboard", color: "#0077ED" },
  ...COMPASSES,
  { id: "toolbox", label: "Toolbox", question: "Công cụ & tiện ích",  icon: "build",     color: "#727784" },
  { id: "library", label: "Library", question: "Tri thức & ghi chú", icon: "menu_book", color: "#727784" }
];
...
export { ADVISOR, COMPASSES, SECTIONS, NAV, PIPELINE_STAGES, LEADS, ACTIVE_CLIENTS, INTERACTIONS, ALLOCATION, COURSES, SKILL_GAPS, CERTS, BADGES, NETWORK_PEOPLE, KPI_VALUE, KPI_TRAD, OM_LIST, TOOLS, PRODUCTS, TASKS, ONBOARD_STEPS, ANNOUNCEMENTS };
